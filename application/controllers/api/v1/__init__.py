...
mod.add_url_rule(
    "/api/v1/faction/<int:faction_id>/config/ts-stats", view_func=faction.config.toggle_ts_stats, methods=["PUT"]
)
...
mod.add_url_rule("/api/v1/user/settings/public-data", view_func=user_settings.toggle_public_data, methods=["PUT"])
