...
class OrganizedCrimeTwo(BaseModel):
    faction = ForeignKeyField(Faction, null=False)
    oc_id = IntegerField(null=False)

    crime_name = CharField(null=False)
    crime_difficulty = SmallIntegerField(null=False)
    ...
    class Meta:
        primary_key = CompositeKey("faction", "oc_id")
