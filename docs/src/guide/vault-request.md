...
This guide shows you how to make a vault request through Tornium against your faction vault balance. This requires that your faction has set up Tornium for banking already. You can send your vault requests through either the [Tornium Discord bot](#discord-bot) or through [Tornium's website](#website).
...
![Successful vault request](../images/tornium-banking-withdraw-request.png)
