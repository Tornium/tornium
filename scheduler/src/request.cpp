...
std::optional<scheduler::Request> scheduler::parse_request(char *data_, const size_t &bytes_received, const size_t& buffer_max_length) {
    ...
    try {
        ...
        std::cerr << "Unable to parse request... SKIPPING" << std::endl;
        return std::nullopt;
    }
...
std::optional<scheduler::Request> scheduler::request_by_path(std::multimap<std::string, scheduler::Request&>& requests_map, std::string path) {
...
bool scheduler::enqueue_request(std::multimap<std::string, scheduler::Request&>& requests_map, scheduler::Request &request_) {
...
size_t scheduler::requests_count(std::multimap<std::string, scheduler::Request&>& requests_map) { return requests_map.size(); }

void scheduler::remove_request(std::multimap<std::string, scheduler::Request&>& requests_map, std::string request_key) { requests_map.erase(request_key); }

void scheduler::decrement_niceness(std::multimap<std::string, scheduler::Request&>& requests_map) {
    // TODO: Rename function
