...
export const APP_SCOPE = "identity faction:crimes";
// FIXME: Revert before release
// export const CACHE_ENABLED = !DEBUG && "caches" in window;
export const CACHE_ENABLED = false;
export const GM_PREFIX = "tornium-crimes";
export const CACHE_NAME = `${GM_PREFIX}-cache`;
...
const localGMValue = localStorage.getItem(`${GM_PREFIX}:test`);
